...
function Sidebar() {
    ...
    return (
        <div className="fixed w-14 sm:w-45 md:w-50 lg:w-60 p-3 sm:p-10 h-svh border-r-1 border-[#fff4] bg-[#393E46] flex flex-col gap-12 font-[Inter] text-white items-center">
            ...
            <div className="flex flex-col justify-between h-full">
                <div className='flex flex-col gap-10'>
                    <div onClick={() => {setActiveButton('home'); window.location.href = "/"}} className="flex items-center gap-3">
                    ...
                    <div onClick={() => {setActiveButton('search'); window.location.href = "/search"}} className="flex items-center gap-3">
                    ...
                    <div onClick={() => {setActiveButton('profile'); window.location.href = "/profile"}} className="flex items-center gap-3">
                    ...
                    <div onClick={() => {setActiveButton('post'); window.location.href = "/post"}} className="flex items-center gap-3">
